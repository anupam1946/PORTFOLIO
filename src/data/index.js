...
export const achievements = [
  {
    ...
    issuer: "Xdezo Technologies",
    date: "June 2023 - September 2023",
    expiryDate: null,
    credentialId: "XDEZO-FE-INT-2023",
    credentialUrl: "#",
    description: "Internship focused on building and maintaining client-facing React applications with pixel-perfect UI implementation and performance optimization.",
    details: "Completed a 3-month frontend development internship at Xdezo Technologies in Pokhara. Built responsive React applications, collaborated with designers to implement pixel-perfect UIs, and improved application performance by 40% through code splitting and lazy loading. Gained hands-on experience in modern web development practices and agile development workflows.",
    tags: ["React", "Frontend", "UI Development", "Performance Optimization"],
    featured: true,
    color: "#6366f1",
  ...
  },
  {
    ...
    issuer: "Milo Logic Pvt. Ltd.",
    date: "February 2024 - Present",
    expiryDate: null,
    credentialId: "MILO-FSD-2024",
    credentialUrl: "#",
    description: "Full stack development role involving responsive web page development, CMS dashboard creation, and client project delivery.",
    details: "Working as a Full Stack Developer at Milo Logic Pvt. Ltd. in Kathmandu. Developed responsive web pages using HTML, CSS, and JavaScript. Assisted in building a CMS dashboard that reduced content update time by 60% for clients. Worked on multiple client projects, implementing both frontend and backend solutions, and maintained code quality and best practices across all deliverables.",
    tags: ["Full Stack", "React", "Node.js", "CMS Development"],
    featured: true,
    color: "#0ea5e9",
    image: "/certificates/milo-logic.jpg"
  },
  {
    id: 3,
    title: "System Administrator",
    issuer: "Steller Tech Labs",
    date: "2023 - 2024",
    expiryDate: null,
    credentialId: "STELLER-SYS-ADM-2023",
    credentialUrl: "#",
    description: "System administration and infrastructure management with focus on server maintenance, user support, and network operations.",
    details: "Served as a System Administrator at Steller Tech Labs, responsible for managing server infrastructure, user account management, and network operations. Maintained system security, performed regular backups, monitored system performance, and provided technical support to end users. Gained valuable experience in infrastructure management and IT operations.",
    tags: ["System Administration", "Infrastructure", "Server Management", "IT Operations"],
    featured: false,
    color: "#a855f7",
    image: "/certificates/exp.jpg"
  },
  {
    id: 4,
    ...
    date: "March 2024",
    expiryDate: null,
    credentialId: "HUBSPOT-EMAIL-2024",
    credentialUrl: "#",
    description: "Certification in email marketing strategies, campaign optimization, and audience segmentation using HubSpot platform.",
    details: "Completed HubSpot's Email Marketing certification covering email strategy, list management, campaign creation, and performance analytics. Learned best practices for crafting effective email campaigns, A/B testing, personalization, and measuring ROI. Certified to design and execute professional email marketing campaigns using HubSpot's marketing automation platform.",
    tags: ["Email Marketing", "HubSpot", "Marketing Automation", "Campaign Management"],
    featured: true,
    color: "#f59e0b",
    image: "/certificates/email.marketing.png"
  },
  {
    id: 5,
    ...
    date: "March 2024",
    expiryDate: null,
    credentialId: "HUBSPOT-INBOUND-2024",
    credentialUrl: "#",
    description: "Certification in inbound marketing methodology, lead nurturing, and customer engagement strategies.",
    details: "Completed HubSpot's Inbound Marketing certification covering the inbound methodology, content marketing, lead nurturing, and customer relationship management. Learned to attract, engage, and delight customers through valuable content and strategic marketing. Certified to implement inbound marketing strategies that drive sustainable business growth and build lasting customer relationships.",
    tags: ["Inbound Marketing", "HubSpot", "Content Marketing", "Lead Generation"],
    featured: true,
    color: "#10b981",
    image: "/certificates/inbound marketing.png"
  },
  {
    id: 6,
    ...
    date: "April 2024",
    expiryDate: null,
    credentialId: "UDEMY-REACT-TS-2024",
    credentialUrl: "#",
    description: "Comprehensive course on React with TypeScript, covering modern component patterns, hooks, and type safety.",
    details: "Completed an intensive React and TypeScript course covering component architecture, hooks, context API, and type-safe development practices. Built multiple projects including a complete e-commerce platform and real-time collaboration app. Learned advanced patterns for scalable React applications with strong type safety and best practices for production-ready code.",
    tags: ["React", "TypeScript", "Frontend", "Component Design"],
    featured: false,
    color: "#06b6d4",
    image: "/certificates/react-typescript.jpg"
  },
];
